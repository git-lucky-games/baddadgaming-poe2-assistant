...
This assistant helps POE2 players with builds, items, crafting, and game mechanics. It's a local-only Electron desktop app: no server, you provide your own POESESSID and Anthropic API key.
...
2. **Screenshot Price Lookup** — hotkey or paste a screenshot, Claude Vision parses the item, and it's looked up on the trade API.
...
Electron 33 · React 19 + TypeScript · Tailwind CSS v4 · electron-vite · Zustand · better-sqlite3 · Anthropic SDK
